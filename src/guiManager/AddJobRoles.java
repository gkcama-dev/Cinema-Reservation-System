 ...
 */
public class AddJobRoles extends javax.swing.JDialog {

    /**
     * Creates new form AddEmployee
     */
    public AddJobRoles(java.awt.Frame parent, boolean view) {
        ...
        try {
            ...
            if (job.isEmpty()) {
                ...
                for (int i = 0; i < jTable2.getRowCount(); i++) {
                    String getjob = String.valueOf(jTable2.getValueAt(i, 1));

                    if (getjob.equals(job)) {
                        JOptionPane.showMessageDialog(this, "Job already added !", "Warning", JOptionPane.WARNING_MESSAGE);
                        isFound = true;
                    }
                }
...
//                
//                mySQL.executeIUD("DELETE FROM `emp_type` WHERE `id` = '"+id+"'");
//                
//                loadJobs();
//                
